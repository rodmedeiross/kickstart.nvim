...
return {
  {
    ...
    config = function()
      vim.keymap.set('n', "<C-n>", '<Cmd>Neotree toggle<cr>', { silent = true })               -- opens file system in sidebar
      vim.keymap.set('n', "<C-b>", "<Cmd>Neotree toggle buffers right<cr>", { silent = true }) -- opens buffers in sidebar
